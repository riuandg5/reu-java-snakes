...
SNAKE.Snake = SNAKE.Snake || (function() {
    ...
    return function(config) {
        ...
        me.handleArrowKeys = function(keyNum) {
            ...
            switch (keyNum) {
                case 37:
                    if ( lastMove !== 1 || snakeLength === 0 ) {
                        moveQueue.unshift(3);
                    }
                    break;    
                case 38:
                    if ( lastMove !== 2 || snakeLength === 0 ) {
                        moveQueue.unshift(0);
                    }
                    break;    
                case 39:
                    if ( lastMove !== 3 || snakeLength === 0 ) {
                        moveQueue.unshift(1);
                    }
                    break;    
                case 40:
                    if ( lastMove !== 0 || snakeLength === 0 ) {
                        moveQueue.unshift(2);
                    }
                    break;  
            }
...
SNAKE.Board = SNAKE.Board || (function() {
    ...
    return function(inputConfig) {
        ...
        function createBoardElements() {
            ...
            elmAboutPanel.innerHTML = "<b>REU JAVA SNAKES</b>";
            elmLengthPanel = document.createElement("div");
            elmLengthPanel.className = "snake-panel-component";
            elmLengthPanel.innerHTML = "Length: 0";
        ...
        function createWelcomeElement() {
            ...
            if (config.fullScreen) {
                fullScreenText = "<p align=center>Press F11 to play in Full Screen mode.</p>";   
            }
            welcomeTxt.innerHTML = "<b>REU JAVA SNAKES</b><p></p>Use the <strong>arrow keys</strong> on your keyboard to play the game. " + fullScreenText + "<p></p>";
        ...
        function createTryAgainElement() {
            ...
            tryAgainTxt.innerHTML = "<b>REU JAVA SNAKES</b><p></p>Snake died. <p></p>";
